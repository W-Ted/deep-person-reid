...
from torchreid.losses import CrossEntropyLoss, AngleLoss_nomargin, CenterLoss
from torchreid.utils import AverageMeter, open_specified_layers, open_all_layers
from torchreid import metrics


class ImageCenterAngularEngine(engine.Engine):
	...
	def __init__(self, datamanager, model, optimizer,
	             ...
	             label_smooth=True):
		super(ImageCenterAngularEngine, self).__init__(datamanager, model, optimizer, scheduler, use_cpu)
		...
		self.criterion_x = AngleLoss_nomargin(
			num_classes=self.datamanager.num_train_pids,
			use_gpu=self.use_gpu,
