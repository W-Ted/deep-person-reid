...
def build_engine(args, datamanager, model, optimizer, scheduler):
    if args.app == 'image':
        if args.loss == 'softmax':
        ...
        elif args.loss == 'a-softmax':
            engine = torchreid.engine.ImageSphereEngine(
                datamanager,
                model,
                optimizer,
                scheduler=scheduler,
            ...
            engine = torchreid.engine.ImageCenterEngine(
                datamanager,
                model,
                optimizer,
                weight_t=args.weight_t,
            ...
            engine = torchreid.engine.ImageNpairEngine(
                datamanager,
                model,
                optimizer,
                scheduler=scheduler,
            ...
            engine = torchreid.engine.ImageMultiSimilarityEngine(
                datamanager,
                model,
                optimizer,
                scheduler=scheduler,
            ...
            engine = torchreid.engine.ImageHistogramEngine(
                datamanager,
                model,
                optimizer,
                scheduler=scheduler,
        ...
        elif args.loss == 'center+angular':
            engine = torchreid.engine.ImageCenterAngularEngine(
                datamanager,
                model,
                optimizer,
                weight_t=args.weight_t,
            ...
            engine = torchreid.engine.ImageFocalEngine(
                datamanager,
                model,
                optimizer,
                scheduler=scheduler,
            ...
            engine = torchreid.engine.ImageCosfaceEngine(
                datamanager,
                model,
                optimizer,
                scheduler=scheduler,
