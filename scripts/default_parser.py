...
def init_parser():
    ...
    parser.add_argument('--app', type=str, default='image', choices=['image', 'video'],
                        help='application')
    parser.add_argument('--loss', type=str, default='softmax', choices=['softmax', 'triplet', 'a-softmax', 'center', 'n-pair', 'ms', 'histogram', 'center+angular', 'focal', 'cosface', 'arcface'],
                        help='methodology')
    ...
    parser.add_argument('--new-layers', type=str, nargs='+', default=['classifier'],    # new_layers=['fc', 'classifier']
